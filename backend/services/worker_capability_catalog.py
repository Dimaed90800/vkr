...
_WORKERS: tuple[WorkerCapability, ...] = (
    ...
    WorkerCapability(
        worker_name="targeted_object_harvester",
        tool_name="targeted_object_harvester",
        worker_class="access_control",
        scenario_types=["access_control_bola"],
        observation_types=["targeted_object_harvest_result"],
        owasp_categories=["API1_BROKEN_OBJECT_LEVEL_AUTHORIZATION"],
        status="implemented",
        adapter_available=True,
        execution_mode="sync",
        ...
        requires_corpus=False,
        risk_level="medium",
        notes="Deterministic safe-GET harvesting for owner-owned typed object refs used by BOLA pair builder.",
    ),
    WorkerCapability(
