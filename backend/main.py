...
try:
    ...
    from backend.api.routes_observations import observations_router, verification_plans_router
    from backend.api.routes_evidence import evidence_router
    from backend.api.routes_judge_apply import judge_apply_router
    ...
    from backend.api.routes_reports import reports_router
    from backend.api.routes_callbacks import callbacks_router
    ...
    from api.routes_observations import observations_router, verification_plans_router
    from api.routes_evidence import evidence_router
    from api.routes_judge_apply import judge_apply_router
    ...
    from api.routes_callbacks import callbacks_router
...
app.include_router(verification_plans_router)
app.include_router(evidence_router)
app.include_router(judge_apply_router)
